...
#ifndef _Z_PML_NTV_TIME_VALUE_H_
#define _Z_PML_NTV_TIME_VALUE_H_
...
namespace ntv {
    ...
    class CTK_API TimeValue : public ValueBase
    {
    public:
        typedef TimeValue _Self;
        typedef ValueBase _Super;
        typedef Time store_type;
        typedef Time value_type;

    public:
        TimeValue(Unit* _owner=0);
        TimeValue(value_type _v, Unit* _owner=0);
...
#endif // !_Z_PML_NTV_TIME_VALUE_H_
