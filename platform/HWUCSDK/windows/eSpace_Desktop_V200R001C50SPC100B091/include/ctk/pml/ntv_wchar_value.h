...
#ifndef _Z_PML_NTV_WCHAR_VALUE_H_
#define _Z_PML_NTV_WCHAR_VALUE_H_
...
namespace ntv {
    ...
    class CTK_API WcharValue : public ValueBase
    {
    public:
        typedef WcharValue _Self;
        typedef ValueBase _Super;
        typedef Wchar store_type;
        typedef wchar value_type;

    public:
        WcharValue(Unit* _owner=0);
        WcharValue(value_type _v, Unit* _owner=0);
...
#endif // !_Z_PML_NTV_WCHAR_VALUE_H_
